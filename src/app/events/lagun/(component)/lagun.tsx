...
const LagunPage = () => {
  ...
  dressCode: (t("lagunEventDressCode")),
  gallery: [
  ...
  return (
    <div className="bg-[#FFF8E1]"> 
      ...
      <section className="relative h-[60vh] md:h-[70vh] w-full flex items-center justify-center text-center text-white">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight">{t("lagunEventTitle")}</h1>
    ...
    <motion.div>
      ...
      >
        ...
        >
          ...
          <p className="max-w-3xl mx-auto mt-4 text-gray-600">{t("storyHaldiDescription")}
          </p>
        </motion.div>
