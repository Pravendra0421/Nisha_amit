...
const SangeetPage = () => {
  const {t} = useLanguage();
  const haldiData = {
  heroImage: "https://res.cloudinary.com/ddguf7pkw/image/upload/v1754549542/Gemini_Generated_Image_nr9eucnr9eucnr9e_obee2t.png",
  date: (t("eventDate")),
  time: (t("sangeetEventTime")),
  venue:(t("eventVenue")),
  ...
  dressCode: (t("sangeetEventDressCode")),
  gallery: [
  ...
  return (
    <div className="bg-[#FFF8E1]"> {/* A light creamy yellow background */}
      ...
      <section className="relative h-[60vh] md:h-[70vh] w-full flex items-center justify-center text-center text-white">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-tight">{t("sangeetEventTitle")}</h1>
      ...
      <main className="max-w-5xl mx-auto px-4 py-16 sm:py-24">
        ...
        >
          <h2 className="text-3xl font-serif text-amber-800">{t("storySangeetTitle")}</h2>
          <p className="max-w-3xl mx-auto mt-4 text-gray-600">
          {t("storySangeetDescription")}
          </p>
        </motion.div>
